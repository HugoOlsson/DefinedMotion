...
import { codermugScene } from './hugoScenes/codermug'
import { guitarPlayingScene } from './hugoScenes/guitarPlayingScene'
import { solutionSpaceScene } from './hugoScenes/solutionSpaceScene'
import { stockPriceScene } from './hugoScenes/stockPriceScene'
...
export const entryScene: () => AnimatedScene = () => codermugScene()
