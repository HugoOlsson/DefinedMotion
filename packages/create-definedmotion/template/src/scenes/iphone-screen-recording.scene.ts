...
function createIphoneScreenRecordingScene(): AnimatedScene {
  return new AnimatedScene(
    ...
    async (scene) => {
      ...
      const phoneModel = await loadGLB(scene.asset('for_tests/models_3d/iphone_14_pro.glb'))
      ...
      const studioEnvironment = await loadHDRIData(scene.asset(HDRIs.photoStudio1), 3)
