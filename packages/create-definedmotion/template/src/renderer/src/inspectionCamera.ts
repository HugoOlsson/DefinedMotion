import type { AutomationCameraSummary, InspectObjectMetadata } from '../../automation/types'
import { AutomationCommandError } from './automationError'
import { inspectCamera } from './sceneInspection'
import { MAIN_CAMERA_ID, type AnimatedScene, type InspectionCamera } from './lib/scene/sceneClass'
