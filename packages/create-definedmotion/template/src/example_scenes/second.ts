...
import { COLORS, hexColor } from '../renderer/src/lib/rendering/helpers'
import { placeNextTo } from '../renderer/src/lib/scene/helpers'
import { moveToAnimation, setOpacity } from '../renderer/src/lib/animation/animations'
import {
  concatInterpols,
  easeInOutQuad,
  posXSigmoid
} from '../renderer/src/lib/animation/interpolations'
...
import { latexOTest } from '../renderer/src/lib/rendering/svgObjects'
import { parseSVGString, vectorizeSVGStructure } from '../renderer/src/lib/rendering/svg/parsing'
import { drawVectorizedNodes } from '../renderer/src/lib/rendering/svg/drawing'
