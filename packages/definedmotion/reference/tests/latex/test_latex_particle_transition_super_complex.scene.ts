...
export default defineScene({
  id: 'test-latex-particle-transition-super-complex',
  name: 'LaTeX Particle Transition Super Complex',
  isTest: true,
  create: test_latex_particle_transition_super_complex
})
export function test_latex_particle_transition_super_complex(): AnimatedScene {
