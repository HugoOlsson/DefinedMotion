...
| spherical-triangle-explainer | example | Spherical Triangle Explainer | `examples/spherical-triangle-explainer/spherical_triangle_explainer.scene.ts` |
...
| test-fourier-series-machine | test | Fourier Series Machine Integration Contract | `tests/integration/fourier-series-machine/fourier_series_machine.scene.ts` |
